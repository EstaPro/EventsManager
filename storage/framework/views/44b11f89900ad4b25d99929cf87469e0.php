        ...
        <div class="dashboard-stat-card bg-primary bg-gradient text-white rounded-3 p-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h2 class="stat-value mb-0"><?php echo e(number_format($stats['total'])); ?></h2>
                </div>
                <div class="stat-icon">
            ...
            <div class="stat-footer mt-2">
                <small class="opacity-75">
                    <i class="bi bi-arrow-up"></i> <?php echo e($stats['new_today']); ?> today
                </small>
            </div>
        </div>
    </div>
        ...
        <div class="dashboard-stat-card bg-success bg-gradient text-white rounded-3 p-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h2 class="stat-value mb-0"><?php echo e($stats['visible']); ?></h2>
                </div>
                <div class="stat-icon">
        ...
        <div class="dashboard-stat-card bg-info bg-gradient text-white rounded-3 p-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h2 class="stat-value mb-0"><?php echo e(number_format($stats['exhibitors'])); ?></h2>
                </div>
                <div class="stat-icon">
            ...
            <div class="stat-footer mt-2">
                <small class="opacity-75">
                    <?php echo e($stats['with_company']); ?> with companies
                </small>
            </div>
        </div>
    </div>
        ...
        <div class="dashboard-stat-card bg-warning bg-gradient text-white rounded-3 p-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h2 class="stat-value mb-0"><?php echo e(number_format($stats['visitors'])); ?></h2>
                </div>
                <div class="stat-icon">
            ...
            <div class="stat-footer mt-2">
                <small class="opacity-75">
                    <?php echo e($stats['new_this_week']); ?> new this week
                </small>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/runner/work/EventsManager/EventsManager/resources/views/orchid/users/enhanced-stats.blade.php ENDPATH**/ ?>