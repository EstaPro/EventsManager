    ...
    <div class="col-md-3">
        <div class="card bg-warning bg-gradient text-dark h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h3 class="mb-0"><?php echo e($stats['hidden']); ?></h3>
    ...
    <div class="col-md-3">
        <div class="card bg-info bg-gradient text-dark h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h3 class="mb-0"><?php echo e($stats['dynamic']); ?></h3>
...
<?php /**PATH /home/runner/work/EventsManager/EventsManager/resources/views/orchid/content/widget-stats.blade.php ENDPATH**/ ?>