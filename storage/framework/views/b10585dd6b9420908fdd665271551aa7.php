<div class="form-group row row-cols-sm-2 align-items-stretch">
    <?php if(isset($title)): ?>
        <label for="<?php echo e($id); ?>" class="col-sm-3 text-wrap form-label text-balance">
            <?php echo e($title); ?>
...
<?php endif; ?>
<?php /**PATH /home/runner/work/EventsManager/EventsManager/vendor/orchid/platform/resources/views/partials/fields/horizontal.blade.php ENDPATH**/ ?>