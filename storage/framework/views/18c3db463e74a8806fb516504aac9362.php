        ...
        <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1">
                <h5 class="mb-1" style="font-weight: 600; color: #000;">
                    Editing: <?php echo e(strtoupper($languageCode)); ?> Translations
                </h5>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover mb-0 translation-table">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $translation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        ?>
                        <tr class="translation-row" data-index="<?php echo e($index); ?>">
                            <td class="text-center">
                                <span class="row-number"><?php echo e(is_numeric($index) ? $index + 1 : $loop->iteration); ?></span>
                            </td>
                            <td>
                                <input
                                    type="text"
                                    class="form-control form-control-sm translation-key"
                                    name="translations[<?php echo e($loop->index); ?>][key]"
                                    value="<?php echo e($translationKey); ?>"
                            ...
                            <td>
                                    <textarea
                                        ...
                                        name="translations[<?php echo e($loop->index); ?>][value]"
                                        rows="2"
                                        placeholder="Enter translation..."
                                        required
                                    ><?php echo e($translationValue); ?></textarea>
                            </td>
                            <td class="text-center">
...
<script>
    let rowIndex = <?php echo e(count($translations)); ?>;
        ...
        languageSelector.addEventListener('change', function() {
            if (hasUnsavedChanges) {
                if (confirm('You have unsaved changes. Do you want to leave without saving?')) {
                    ...
                    this.value = '<?php echo e($languageCode); ?>';
                }
            } else {
                window.location.href = window.location.pathname + '?languageCode=' + this.value;
            }
...
<?php /**PATH /home/runner/work/EventsManager/EventsManager/resources/views/orchid/language/editor.blade.php ENDPATH**/ ?>