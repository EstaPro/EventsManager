<div class="d-flex align-items-center justify-content-between w-100">
    ...
    <div class="d-flex align-items-center" style="min-width: 200px;">
        <?php if($p1): ?>
            <div class="position-relative mr-2">
                <img src="<?php echo e($p1->avatar_url ?? 'https://www.gravatar.com/avatar/' . md5(strtolower(trim($p1->email))) . '?d=mp'); ?>"
            ...
            <div>
                <div class="d-flex align-items-center">
                    <strong class="mr-2"><?php echo e($p1->name); ?> <?php echo e($p1->last_name); ?></strong>
                    <?php if($p1->roles->contains('slug', 'exhibitor')): ?>
                ...
                <small class="text-muted d-block text-truncate" style="max-width: 180px;">
                    ...
                    <?php echo e($p1->company->name ?? $p1->email); ?>
    ...
    <div class="d-flex align-items-center" style="min-width: 200px;">
        <?php if($p2): ?>
            <div class="position-relative mr-2">
                <img src="<?php echo e($p2->avatar_url ?? 'https://www.gravatar.com/avatar/' . md5(strtolower(trim($p2->email))) . '?d=mp'); ?>"
                     class="rounded-circle border"
                     style="width: 40px; height: 40px; object-fit: cover;">
                <span class="position-absolute bottom-0 right-0 bg-success rounded-circle"
                      style="width: 10px; height: 10px; border: 2px solid white;"></span>
            ...
            <div>
                <div class="d-flex align-items-center">
                    <strong class="mr-2"><?php echo e($p2->name); ?> <?php echo e($p2->last_name); ?></strong>
                    <?php if($p2->roles->contains('slug', 'exhibitor')): ?>
                        <span class="badge bg-primary-light text-primary px-2 py-1" style="font-size: 0.7rem;">
                            <i class="bs.building mr-1"></i> Exhibitor
                        </span>
                    <?php else: ?>
                ...
                <small class="text-muted d-block text-truncate" style="max-width: 180px;">
                    <i class="bs.envelope-fill me-1" style="font-size: 0.7rem;"></i>
                    <?php echo e($p2->company->name ?? $p2->email); ?>
...
<?php /**PATH /home/runner/work/EventsManager/EventsManager/resources/views/orchid/field/conversation-participants.blade.php ENDPATH**/ ?>